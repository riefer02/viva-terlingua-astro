...
export type StrapiEntity<T> = {
  ...
  meta: Record<string, unknown>;
    ...
    for (const [schemaName, schema] of Object.entries(schemas)) {
      ...
      typeDefinitions += `export type ${interfaceName}Collection = StrapiCollection<${interfaceName}>;\n`;
      typeDefinitions += `export type ${interfaceName}Entity = StrapiEntity<${interfaceName}>;\n\n`;
    }
